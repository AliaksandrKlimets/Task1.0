...
public class Helper {
    ...
    public void searchProduct(Van van_elem) {
        ...
        switch (Integer.parseInt(scanner.nextLine())) {
            case 1:
                logger.debug("User have chosen search by cost");
                search.searchCost(van);
                break;
            case 2:
                logger.debug("User have chosen search by weight");
                search.searchWeight(van);
                break;
            case 3:
                logger.debug("User have chosen search by amount");
                search.searchAmount(van);
                break;
            case 4:
                logger.debug("User have chosen search by state");
                search.searchPhysicalState(van);
                break;
            case 5:
                logger.debug("User have chosen search by kind");
    ...
    public String setPhysicalState(int i) {
        switch (i) {
            ...
            case 2:
                return "Ground";
            case 3:
                return "Soluble in cans";
            case 4:
                return "Soluble in packets";
            default:
                return "Corn";
        }
    }
